...
if (isset($_POST['submit'])) {
    ...
    if ($new_pass === $confirm_pass) {
        ...
        $query = "SELECT binary password FROM login_tab WHERE staff_id = '$staff_id'";
        ...
        {
            $update_query = "UPDATE `login_tab` SET password = '$new_pass' WHERE staff_id = '$staff_id'";
    ...
    <div class="container">
        ...
        <form name="change_password" method="POST">
            ...
            <div class="text-center">
                ...
                <br><br>
                <button type="button" class="btn btn-back" onclick="window.location.href='faculty_dashboard.php';">Back</button>
            </div>
        </form>
    </div>
